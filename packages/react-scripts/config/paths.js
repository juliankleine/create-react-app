...
if (
  ...
  module.exports = {
    ...
    appPath: resolveApp('.'),
    serverBuild: resolveOwn('../../server'),
    appBuild: resolveOwn('../../build'),
    appPublic: resolveOwn('template/public'),
    appHtml: resolveOwn('template/public/index.html'),
    serverIndexJs: resolveModule(resolveOwn, 'template/src/server/index'),
    appIndexJs: resolveModule(resolveOwn, 'template/src/app/index'),
    appPackageJson: resolveOwn('package.json'),
    serverSrc: resolveOwn('template/src/server'),
